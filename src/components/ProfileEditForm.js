...
class ProfileEditForm extends Component {
  ...
  componentWillReceiveProps(props, state) {
    ...
    this.setState({
      ...
      officeTimeEnd: oend,
      majors: props.currentMember.majors,
      minors: props.currentMember.minors,
    ...
    return (
      <div style={this.props.isFormOpen ? {} : { display: "none" }} className="event-modal">
        <form onSubmit={this._updateProfile}>
			...
			<br/>
            <input type="submit" onClick={this._updateMember} className="manage-btn" value="Update Profile"/>
        </form>
      </div>
    );
  }
